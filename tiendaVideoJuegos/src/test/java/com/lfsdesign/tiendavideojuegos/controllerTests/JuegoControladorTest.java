...
class JuegoControladorTest {
	...
	@Test
	void testAddJuego() throws Exception {
    ...
    @Test
    void testGetAllJuegos() throws Exception {
    ...
    @Test
    void testDeleteJuegoById() throws Exception {
	...
	@Test
    void testGetJuegoById() throws Exception {
	...
	@Test
	void testActualizarJuegoById() throws Exception {
